...
class MyCustomHandler(CustomLogger):
    ...
    def log_pre_api_call(self, model, messages, kwargs):
        print_verbose("xun Pre-API Call")

    def log_post_api_call(self, kwargs, response_obj, start_time, end_time):
        print_verbose("xun Post-API Call")

    def log_stream_event(self, kwargs, response_obj, start_time, end_time):
        print_verbose("xun On Stream")

    def log_success_event(self, kwargs, response_obj, start_time, end_time):
        print_verbose("xun On Success!")

    async def async_log_success_event(self, kwargs, response_obj, start_time, end_time):
        print_verbose("xun On Async Success!")
    ...
    async def async_log_failure_event(self, kwargs, response_obj, start_time, end_time):
        try:
            print_verbose("xun On Async Failure !")
        except Exception as e:
            print_verbose(f"xun Exception: {e}")
